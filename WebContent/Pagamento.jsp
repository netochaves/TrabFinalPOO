      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Administração de Pagamentos</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                ...
                <div class="col-lg-8" style="float:right">
                  <div class="card">
                    <div class="card-header d-flex align-items-right">
                      <h3 class="h4">Pagamentos</h3>
                    </div>
                    <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Registrar Pagamento</button>  	                                                
                    <div class="card-body">
                    ...
                    <%}%>
                      <table class="table table-bordered table-hover">
                       ...
                       <% ArrayList<Pagamento> pagamentos = (ArrayList<Pagamento>)request.getAttribute("pagamentos");%>
                          	<% if(pagamentos==null){pagamentos = PagamentoDAO.getAll();} %>
                        ...
                        <tbody>                              	
                          	<tr>
                          		...
                          		%>
                          		<%Fatura f = FaturaDAO.pesquisar(c.getMes(), c.getAno(), c.getCartao()); %>
                          		<td><%=f.getValorFinal() %></td>
                          		<td><%=c.getValor() %></td>                            
                          	</tr>                         	
                        </tbody>
                        <%}%>
					         ...
					         <div class="modal-content">
					           <div class="modal-header">
					            ...
					            <div class="modal-body">
					            	<form action="Pagamento" method="post" id="form1">
