                ...
                <div class="col-lg-5">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Cadastrar Titular</h3>
                    </div>
                    <div class="card-body">
                    ...
                    <%if(messages!=null){ %>
                    	<%for(String s : messages){ %>
						 ...
						 <% } %>
                    <%}%>
                      <form method="post" action="Titular">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-hover">
                       ...
                       <% ArrayList<Cliente> titulares = (ArrayList<Cliente>)request.getAttribute("titulares");%>
                          <%int i=0; %>
                          	<% if(titulares==null){titulares = ClientesDAO.getAllTitulares();} %>
                        ...
                        <tbody>                              	
                          	<tr data-toggle="collapse" data-target="#myCollpase<%=i%>" aria-expandede="false" aria-controls="myCollpase<%=i%>">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a href="Titular?action=remover&cpf=<%=c.getCpf()%>">Remover</a></li>
					              <li><a data-toggle="modal" data-target="#meuModal" data-cpf="<%=c.getCpf()%>" data-nome="<%=c.getNome() %>" data-endereco="<%=c.getEndereco() %>" data-cidade="<%=c.getCidade() %>" data-estado="<%=c.getEstado() %>">Editar</a></li>
                                  <li><a href="Dependente?action=listarDependentes&cpfTitular=<%=c.getCpf()%>">Dependentes</a></li>
                                </ul>
                                </div>
                                </div>
								</td>                              
					              ...
					              <div role="document" class="modal-dialog">
					                    <div class="modal-content">
					                            <div class="modal-header">
					                              <h4 id="exampleModalLabel" class="modal-title">Alterar Titular</h4>
					                              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
					                            </div>
					                            <div class="modal-body"> 
					                              <form action="Titular" method="post" id="form1">
					                              <div class="form-group">
					                                  <label>CPF</label>
